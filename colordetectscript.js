...
function buildPalette(colorsList) {
  ...
  for (let i = 0; i < orderedByColor.length; i++) {
    ...
    let hextext = document.createTextNode(hexColor);
    colorElement.onmouseover = function(){
      colorElement.appendChild(hextext);
    }
    colorElement.onmouseout = function () {
      colorElement.removeChild(hextext);
    }
  }
}
